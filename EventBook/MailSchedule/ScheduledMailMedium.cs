...
{
    public class ScheduledMailMedium : IJob
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            ...
            var userIDs_Medium = (from x1 in db.SubscriptionTables where x1.Priority == "Medium" select x1.Event_Id).Distinct().ToList();
            sm.Priority(userIDs_Medium);
        }
    }
}
