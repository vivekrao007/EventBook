...
{
    public class ScheduledMailLow : IJob
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            ...
            var userIDs_Low = (from x1 in db.SubscriptionTables where x1.Priority == "Low" select x1.Event_Id).Distinct().ToList();
            sm.Priority(userIDs_Low);
        }
    }
}
